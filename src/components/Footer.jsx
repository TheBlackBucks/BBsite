      ...
      <div className="footer">
        <div className="footer-top">
          <div className="footer-top-left">
            ...
            <p className="dash flex">
              Built with
              <span className="heart-icon">
                <AiFillHeart size={22} className="mx-1 mt-0.5" />
              </span>
            ...
            <div className="footer-contact-links">
              ...
              <a href="tel:9311777388" className="mail">
                <MdLocalPhone />
            ...
            <div className="footer-right-bottom">
              ...
              <div className="footer-other-links">
                <div className="same-row-links">
                  <a href="https://unstop.com/about" className="divider">
                    About Us
                  </a>
                  <a
                ...
                <div className="same-row-links">
                  <a href="https://unstop.com/our-partners" className="divider">
                    Partners
                  </a>
                  <a href="https://unstop.com/faq" className="divider">
                    FAQs
                  </a>
